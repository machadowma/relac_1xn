...
<body>
	...
	try {
		...
		$sth = $dbh->prepare('SELECT * from veiculo');
		$sth->execute();
		...
		foreach($result as $row) {
			...
			echo "<td><a href='excluir.php?renavam=".$row["renavam"]."'>Excluir</a></td>";
			echo "<td><a href='alterar_formulario.php?renavam=".$row["renavam"]."'>Alterar</a></td>";
			echo "</tr>";
		}
